...
{
	/* FIXME: You will write this function */
    // Assert that the array was allocated properly and that the size is greater than 0
    assert(v != NULL && v->size > 0);
    // Assert that pos is less than the array size and that it's greater than or equal to 0
